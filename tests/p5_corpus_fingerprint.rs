...
`known_gaps`.",
    ...
    Dimension {
        ...
        carriers: &[
            ...
            file("tests/fixtures/p3-bridge-projection/positive/v8/BridgeApi.class"),
            file("tests/fixtures/p3-bridge-projection/positive/v8/BridgeProbe.class"),
            file("tests/fixtures/p3-bridge-projection/negative/v8/FakeBridge.class"),
            file("tests/fixtures/p3-bridge-projection/orphan/v8/OrphanBridge.class"),
            file("tests/fixtures/p3-conditional-values/v8/TernaryCore.class"),
            file("tests/fixtures/p3-conditional-values/v8/TernaryValues.class"),
            file("tests/fixtures/p3-conditional-values/v8/ConditionalBoundarySwitch.class"),
