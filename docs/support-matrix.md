...
| 维度 | 环境/入口 | 状态 | 边界 |
| --- | --- | --- | --- |
| 平台 | Linux x86_64 | Validated（CI） | 当前 `cd6f2f0` 的 [CI 35484396101](https://github.com/LordCasser/jarde/actions/runs/35484396101) stable/MSRV/supply-chain/fuzz-smoke 均通过，含 JDK25 oracle。 |
