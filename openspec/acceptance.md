...
| A09 | 历史 jsr/finally | P0 指令；P1 原始 X1；P2 规范化；P3 恢复 | 无需 normalize 的 X1；3.4b 的真实 token/嵌套覆盖反例；3.5 克隆/origin 与可靠 fallback；P3 恢复另验收 |
