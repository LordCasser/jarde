...
- `.github/workflows/ci.yml` 经官方 `actionlint 1.7.12`（已校验 release SHA-256）检查通过；workflow 内 Cargo 命令串行且设置低内存环境。**Linux x86_64 首次 remote GitHub Actions 仍待包含该 workflow 的 commit 推送后验证。**
