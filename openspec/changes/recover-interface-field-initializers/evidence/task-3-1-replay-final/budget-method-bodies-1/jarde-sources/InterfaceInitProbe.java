...
public interface InterfaceInitProbe {
    ...
    static {
        // jarde: not recovered: the recovery run for `<clinit>()V` stopped (jre_ir_table_missing); the analysis of that member did not complete (budget_exceeded_method_bodies)
    }
}
