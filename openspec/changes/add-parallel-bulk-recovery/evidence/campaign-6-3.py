...
This is the driver the 6.3 run uses, with the worker counts the criteria in
`../verification.md` §14 name: 1, 2, 4, 8 and `auto`. The historical A/B arms stay
available but are off unless asked for; C/D are the shipped CLI.
