...
P1 与验证维护均已归档；当前基线为 `4beb6b9` 加未提交的 3.4 工作区。原任务 1.1–1.3、2.1–2.5、3.1–3.3 共 11 项有交付记录，3.4 已写但未验收。新增 0.1–0.5 后为 **13/25**（0.1、0.5 已完成）；已勾选不表示本轮发现的缺陷已消失。当前顺序：**0.2 → 0.4 → 0.3 → 3.4 → 3.5 → 4.x → 5.x**。本轮仅 review 和修订规划，不新增实现或勾选任务。
