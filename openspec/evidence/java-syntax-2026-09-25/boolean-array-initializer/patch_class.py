...
def main():
    ...
    for _ in range(methods):
        ...
        for _ in range(attr_count):
            ...
            body = pos + 6
            if cp[name_index] == b"values" and cp[desc_index] == b"()[I" and name == b"Code":
    ...
    if len(newarrays) != 1 or len(stores) != 5:
    ...
    manifest = {
        ...
        "method": "values()[Z", "original_code_hex": code.hex(),
