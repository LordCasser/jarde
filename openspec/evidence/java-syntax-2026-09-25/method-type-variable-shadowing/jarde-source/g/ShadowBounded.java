...
public class ShadowBounded<T extends java.lang.Number> extends java.lang.Object {
    ...
    // jarde: generic Signature projection refused for `echo(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;`: unsupported (jvm_signature_scope_unproved): method type parameter `T` duplicates a name in the class or method scope
    public static java.lang.CharSequence echo(java.lang.CharSequence value) {
