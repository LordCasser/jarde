...
public final class MixedBooleanArgument extends java.lang.Object {
    ...
    public static void call(boolean arg0) {
        // jarde: not recovered: the recovery run for `call(Z)V` produced no statement (explanation only); the artifact's own comment lines are below
        // @method call(Z)V
        // @declaration a static method of `MixedBooleanArgument`, member flags 0x0009
        // recovered from bytecode; presentation is not claimed to compile
        // @bytecode 0 1 4 7 10 13 16 17 20 21 24
