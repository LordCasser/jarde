...
public final class TernaryInIfProbe extends java.lang.Object {
    ...
    public int bothMatch(TernaryInIfProbe arg1) {
        // jarde: not recovered: the recovery run for `bothMatch(LTernaryInIfProbe;)I` produced no statement (explanation only); the artifact's own comment lines are below
        // @method bothMatch(LTernaryInIfProbe;)I
