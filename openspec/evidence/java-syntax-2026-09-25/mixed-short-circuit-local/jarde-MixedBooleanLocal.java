...
public final class MixedBooleanLocal extends java.lang.Object {
    ...
    static boolean one(boolean arg0) {
        // jarde: not recovered: the recovery run for `one(Z)Z` produced no statement (explanation only); the artifact's own comment lines are below
        // @method one(Z)Z
        // @declaration a static method of `MixedBooleanLocal`, member flags 0x0008
        // recovered from bytecode; presentation is not claimed to compile
        // @bytecode 0 1 4 7 10 13 16 17 20 21 22 23 26 27
