...
WORK = Path('/tmp/jarde-final-initialization-expanded')
OUT = ROOT / 'openspec/evidence/java-syntax-2026-09-22/initialization-final/expanded'
...
for name, src in sources.items():
  ...
  summary.append({'class':name,'original_javac':code,'jarde_javac':jarde_code,'jadx_javac':jadx_code,'runs':len(flags)})
