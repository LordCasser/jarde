...
public class NarrowArrayStoresRunner {
    ...
    private static void ordinary() throws Exception {
        ...
        Object booleans = Array.newInstance(boolean.class, 3);
        ...
        NarrowArrayStores.class.getMethod("ordinaryBoolean", booleans.getClass()).invoke(null, booleans);
        ...
        System.out.println("ordinary:boolean:" + get(booleans, 0) + "," + get(booleans, 1) + "," + get(booleans, 2));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        component = original ? int.class : boolean.class;
        direct("Boolean", component, 1);
