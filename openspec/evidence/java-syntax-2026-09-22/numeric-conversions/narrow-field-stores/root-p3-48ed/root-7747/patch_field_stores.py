...
def main():
    ...
    method_names_by_field = {
        "byteField": ["setByte", "setByteProduced", "setByteProducedOn"],
        "charField": ["setChar", "setCharProduced", "setCharProducedOn"],
        "shortField": ["setShort", "setShortProduced", "setShortProducedOn"],
