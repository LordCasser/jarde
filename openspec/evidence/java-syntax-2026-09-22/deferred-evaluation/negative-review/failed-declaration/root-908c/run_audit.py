...
EVIDENCE = ROOT / "openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/negative-review/failed-declaration/root-908c"
WORK = Path("/tmp/jarde-deferred-negative-failed-declaration-908c")
