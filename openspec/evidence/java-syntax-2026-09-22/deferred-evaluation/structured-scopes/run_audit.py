...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-structured');O=R/'openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/structured-scopes';O.mkdir(exist_ok=True);W.mkdir(exist_ok=True)
def run(args,n):
