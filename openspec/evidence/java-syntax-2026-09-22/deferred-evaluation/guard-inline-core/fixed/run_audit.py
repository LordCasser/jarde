...
W=Path('/tmp/jarde-guard-inline-final-work-5b2926')
O=Path('/tmp/jarde-guard-inline-final-evidence-5b2926')
...
cli=Path(str(R/'target/debug/jarde-cli'));before=hashlib.sha256(cli.read_bytes()).hexdigest()
