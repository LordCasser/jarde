...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-checks');W.mkdir(exist_ok=True);O=R/'openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/checks';O.mkdir(exist_ok=True)
sources={
