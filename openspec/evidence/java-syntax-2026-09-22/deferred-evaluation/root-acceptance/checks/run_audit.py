...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/var/folders/gm/lzn3ylzx4lz7mx29lftngdz40000gn/T/jarde-root-deferred-accept-uhefu1l1/checks');W.mkdir(exist_ok=True);O=R/'openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/root-acceptance/checks';O.mkdir(exist_ok=True)
sources={
