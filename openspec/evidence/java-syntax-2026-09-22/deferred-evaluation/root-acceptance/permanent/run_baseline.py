...
W=Path('/var/folders/gm/lzn3ylzx4lz7mx29lftngdz40000gn/T/jarde-root-deferred-fixture-accept-yyw2i8sp')
...
audit('DeferredValueOrder','p3-deferred-value-order','DeferredValueOrderRunner',['DeferredEffects','OrderValue'],str(W),'deferred-evaluation/root-acceptance/permanent',True)
shutil.copy2(W/'patch-manifest.json',E/'deferred-evaluation/root-acceptance/permanent/patch-manifest.json')
