...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-root-7747/structured');O=Path('/Users/lordcasser/workspace/projects/jarde/openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/root-7747/structured');O.mkdir(exist_ok=True);W.mkdir(exist_ok=True)
def run(args,n):
