...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-root-nested-producer-ecab');W.mkdir(exist_ok=True)
O=R/'openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/nested-producer-boundary';O.mkdir(exist_ok=True)
