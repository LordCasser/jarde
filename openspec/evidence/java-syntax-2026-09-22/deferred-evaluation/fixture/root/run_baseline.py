...
audit('DeferredValueOrder','p3-deferred-value-order','DeferredValueOrderRunner',['DeferredEffects','OrderValue'],'/tmp/jarde-root-deferred-fixture-0504','deferred-evaluation/fixture/root',True)
audit('FloatingConstants','p3-floating-constants','FloatingRunner',['FloatingSupport'],'/tmp/jarde-root-floating-fixture-0504','floating-constants/final-fixture-before',False)
