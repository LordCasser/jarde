...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-composite-fixed');W.mkdir(exist_ok=True)
O=Path('/tmp/jarde-deferred-composite-fixed-evidence');O.mkdir(exist_ok=True)
