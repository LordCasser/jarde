...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-replay/structured-work2');O=Path('/tmp/jarde-deferred-replay/structured-evidence2');O.mkdir(exist_ok=True);W.mkdir(exist_ok=True)
def run(args,n):
...
for n in names:
 if not (W/(n+'.java')).exists():shutil.copy2(Path('/Users/lordcasser/workspace/projects/jarde/openspec/evidence/java-syntax-2026-09-22/deferred-evaluation/structured-scopes')/(n+'.java'),W/(n+'.java'))
