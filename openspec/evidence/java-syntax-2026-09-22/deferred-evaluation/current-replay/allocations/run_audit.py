...
R=Path('/Users/lordcasser/workspace/projects/jarde');W=Path('/tmp/jarde-deferred-replay/allocations-work');W.mkdir(exist_ok=True);O=Path('/tmp/jarde-deferred-replay/allocations-evidence');O.mkdir(exist_ok=True)
sources={
