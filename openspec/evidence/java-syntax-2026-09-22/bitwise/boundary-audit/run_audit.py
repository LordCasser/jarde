...
EVIDENCE = ROOT / 'openspec/evidence/java-syntax-2026-09-22/bitwise/boundary-audit'
WORK = Path('/tmp/jarde-bitwise-boundary-audit')
...
def main() -> None:
    ...
    if results['frozen_cli_sha256'] != '8cd1f767ba8cde9928bacedc29263d44be8e5e61b46d3b6f00456fac1c7c77cd':
