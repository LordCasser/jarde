...
enum Measure {
    ...
    public static Measure valueOf(java.lang.String arg0) {
        ...
        // @declaration a static method of `Measure`, member flags 0x0009
        // recovered from bytecode; presentation is not claimed to compile
        return (Measure) java.lang.Enum.valueOf(Measure.class, arg0);
    }
    ...
    static {
        ...
        // recovered from bytecode; presentation is not claimed to compile
        Measure.LOW = new Measure("LOW", 0, BoundarySupport.prefixValue(2));
        Measure.HIGH = new Measure("HIGH", 1, BoundarySupport.prefixValue(5));
