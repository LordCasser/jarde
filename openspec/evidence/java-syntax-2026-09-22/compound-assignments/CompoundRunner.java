public final class CompoundRunner {
    public static void main(String[] args) {
        ...
        CompoundProbe.reset();
        int fieldOld = CompoundProbe.postField();
        System.out.println("post-field=" + fieldOld + ":new=" + CompoundProbe.box.value + ":select=" + CompoundProbe.selects);

        CompoundProbe.reset();
        int arrayOld = CompoundProbe.postArray();
        System.out.println("post-array=" + arrayOld + ":new=" + CompoundProbe.data[0] + ":select=" + CompoundProbe.selects);
