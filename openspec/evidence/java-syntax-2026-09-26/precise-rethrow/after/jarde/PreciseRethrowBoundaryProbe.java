...
public final class PreciseRethrowBoundaryProbe extends java.lang.Object {
    ...
    static int multiCatch(int mode) throws java.text.ParseException, java.io.IOException {
        ...
        try {
            if (mode == 1) {
                throw new java.text.ParseException("multi-parse", 5);
            } else {
                if (mode == 2) {
                    throw new java.io.IOException("multi-io");
                } else {
                    return 29;
                }
            }
            ...
            // @bytecode 36 35
            // the parameter 0 of the invocation at BCI 36 is declared `java.lang.Exception` presents `Object` but the invocation requires `java.lang.Exception` and this layer has no safe reference conversion evidence
            throw e;
        }
    }
