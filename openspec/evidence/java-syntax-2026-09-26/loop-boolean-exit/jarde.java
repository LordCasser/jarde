...
public final class LoopBool extends java.lang.Object {
    ...
    public static int orWhile(int arg0, int arg1) {
        // jarde: not recovered: the recovery run for `orWhile(II)I` produced no statement (explanation only); the artifact's own comment lines are below
        // @method orWhile(II)I
        // @declaration a static method of `LoopBool`, member flags 0x0009
        // recovered from bytecode; presentation is not claimed to compile
        // @bytecode 0 2 6 10 22
