...
当前公开 `recover_method` 返回方法体文本和段表，编译/语义验证尚未执行；不能把 Java/Structured 当成完整源码或已证明等价。2.2 的 accessor 成功主要在低层 API，公开交接仍属 3.1/3.2。P4/P5 保持原边界：P4 等 P3 稳定，P5 只针对已有测量基线，不吞入正确性修复。
